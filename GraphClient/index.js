    ...
    if (req.query.method || (req.body && req.body.method)){
        ...
        switch (method) {
            ...
            case 'sendMail':
                ...
                var toRecipientEmail = (req.query.toRecipientEmail || (req.body && req.body.toRecipientEmail));
                var ccRecipientEmail = (req.query.ccRecipientEmail || (req.body && req.body.ccRecipientEmail));
                ...
                sendMail(subject, bodyContentType, bodyContent, toRecipientEmail, ccRecipientEmail, saveToSentItems, fromUserId)     
...
function getToken() {
    ...
    */
function sendMail(subject, bodyContentType, bodyContent, toRecipientEmail, ccRecipientEmail, saveToSentItems, fromUserId) {
    //return new Promise((resolve, reject) => {
    var body = {
        "message": {
            "subject": subject,
